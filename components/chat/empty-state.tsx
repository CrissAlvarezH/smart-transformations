        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {examplePrompts.map((prompt, index) => (
            <button
              ...
              className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white rounded-full transition-colors duration-200 border border-zinc-700 hover:border-zinc-600"
            >
              {prompt.title}
            </button>
          ))}
